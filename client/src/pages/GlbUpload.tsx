...
function lodLevels(entry: GlbCatalogEntry): readonly GlbLodLevel[] {
  const explicit = entry.lods ?? [];
  return explicit.length ? explicit.map(value => value.level) : Object.freeze([0 as const]);
}
