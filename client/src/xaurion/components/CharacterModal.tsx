...
export function CharacterModal({ isOpen, onClose, player, settings, pending, message, group, onBind, onClass, onWeapon, onRoleSkill, onInventory }: {
  isOpen: boolean; onClose: () => void; player?: z.infer<typeof playerReadbackSchema>; settings?: ControlSettings; pending: boolean; message?: string;
