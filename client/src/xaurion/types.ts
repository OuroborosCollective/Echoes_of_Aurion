...
export interface FloatingCombatText { id: string; text: string; x: number; y: number; color: string; size: 'sm' | 'md' | 'lg' | 'xl'; opacity: number; lifespan: number; maxLifespan?: number; vy: number; scale?: number; isCrit?: boolean; }
