...
export type Ax1SourceEntry = Readonly<{
  ...
  authority: "presentation" | "aurion-readback";
  note: string;
}>;
...
export const AX1_VISIBLE_SOURCE_MANIFEST = Object.freeze(Object.freeze([
  ...
  ["GuildManagementModal", "205d3bbb825dd7275fe01e19f18906f01a000b6879e930ebeac7543252a0bcec", "adapted", "aurion-readback", "Visible surface retained fail-closed until the canonical Aurion guild contract is available."],
  ["NPCEconomyModal", "2eeaba88f7dbd5655d8d616689a4841f3dd18d812273966e9e09dc12c69b0f4f", "adapted", "aurion-readback", "Local prices and merchant mutation are excluded; confirmed Aurion economy state is read-only."],
  ["HomesteadBuilderModal", "6f3a9eb1a33af9290e8158b1132d595d6b5b4918f3b33e7ea77145f29574ee92", "adapted", "aurion-readback", "Builder remains presentation-only until confirmed Aurion state permits an action."],
  ["QuestLogModal", "8bd7e0e0fecd1d6bd8cf596364aec47a02c6df6cb09a5e696f591d55e41d0af2", "projected", "aurion-readback", "Lore is presentational; quest mutation is routed only through confirmed Aurion commands."],
  ...
  ["TerritoryPoliticsModal", "c3527d22b8d1f21e6357a2831e57d51fa63a78a43df0ac02b2797fa71411f67e", "adapted", "aurion-readback", "Ownership, tax and stability writes are routed only through confirmed Aurion commands."],
  ...
  ["ClassSelectModal", "4a9ecabc70fca04f636daf8452713e2dee73f744bb2e18072f07362b4ff9eeea", "adapted", "aurion-readback", "Class authoring is replaced by the canonical Aurion classless discipline projection."],
