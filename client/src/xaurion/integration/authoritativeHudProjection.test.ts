...
export const confirmedPlayer = { profile: { userId: 7, level: 3, totalXp: 290, aurionPoints: 23, victories: 2, selectedClass: "unbound" }, progression: { characterId: "char-7", tracks: [{ trackKind: "weapon", trackId: "greatsword.two_handed.v3", characterId: "char-7", levelExact: "9007199254740993", resultReceiptId: "result-00000001", sourceReceiptId: "source-00000001", receiptHash: "a".repeat(64) }] }, weaponMasteries: [], inventory: [] };
describe("authoritative HUD readback", () => {
  ...
  it("rejects cross-user cache data, legacy class identities, invalid numeric fields and partial world evidence", () => {
