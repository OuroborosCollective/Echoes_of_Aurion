...
export const questReadbackSchema = z.object({ quests: z.array(z.object({
  key: z.enum(["astral_call", "archive_of_echoes", "ember_key", "starfall_resonance", "sunwatch_vanguard", "clockwork_core"]), giver: z.enum(["Lyra", "Orun"]), title: z.string(), objective: z.string(),
