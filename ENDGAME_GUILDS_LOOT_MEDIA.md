...
| ------------------------ | --------------------------------------------------- | ------------------------------------------------------------------ | ---------------------------------------------------------- |
| Skills und Meisterschaft | Eine Fähigkeit gezielt einsetzen.                   | Eigene Skillstufen und flexible Builds entwickeln.                 | `progressionLedger` mit Skill, Quelle und Idempotency-Key. |
...
## Klassenlose Skillmeisterschaft

Aurion verwendet keine Klassen und kein globales Level-Cap. Jede Fähigkeit entwickelt sich durch bestätigte Nutzung und führt eigene, exakte XP. Die Skillstufe wird serverseitig aus einer ansteigenden, cap-freien Kurve abgeleitet.

Kampf-, Sammel-, Handwerks- und Weltfähigkeiten sind getrennte Fortschrittspfade. Die verwendete Fähigkeit bestimmt den Fortschritt. So entstehen Builds durch trainierte Skills und Ausrüstung, nicht durch eine irreversible Klassenwahl.

Alle Skills bleiben trainierbar. Eine hohe Stufe in einem Bereich begrenzt keinen anderen. Jede XP-Vergabe benötigt einen bestätigten Gameplay-Receipt und einen eindeutigen Idempotency-Key.
