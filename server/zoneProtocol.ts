...
export type ZoneWelcome={type:"welcome";protocolVersion:typeof ZONE_PROTOCOL_VERSION;connectionId:string;zoneId:ZoneId;snapshotSeq:number;tick:number;presences:ZonePresence[];mobs:readonly ConfirmedZoneMob[];combatants:readonly ConfirmedZoneCombatant[]};
