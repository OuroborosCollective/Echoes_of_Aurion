...
import { deriveNpcPersonality, parseNpcLifeState, resolveNpcLife, type NpcLifeOpportunity, type NpcRelationshipEvent } from "./npcLifeProtocol";
import type { NpcNeedState } from "./wasdAurionProtocol";
