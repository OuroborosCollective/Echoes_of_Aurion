...
export type QuestKey = "astral_call" | "archive_of_echoes" | "ember_key" | "starfall_resonance" | "clockwork_core";
...
export type EncounterKey = "asterion" | "archive" | "solarium" | "cinder_vault" | "starfall_crater" | "rootgear_foundry";
...
export const aurionEncounters: readonly {
  ...
  { key: "rootgear_foundry", name: "Rootgear-Schmiede", enemyName: "Maschinenwächter", maxBossHp: 400, questKey: "clockwork_core" },
] as const;
