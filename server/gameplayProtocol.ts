...
export type QuestKey = "astral_call" | "archive_of_echoes" | "ember_key" | "starfall_resonance" | "sunwatch_vanguard" | "clockwork_core";
...
export type EncounterKey = "asterion" | "archive" | "solarium" | "cinder_vault" | "starfall_crater" | "sunwatch_bastion" | "rootgear_foundry";
...
export const aurionQuestline: readonly QuestDefinition[] = [
  ...
  },
  {
    ...
    objective: "Errichte einen Vorposten in der Sonnenwacht-Bastion und sichere das Gebiet.",
    requiredLevel: 5,
  ...
  },
  {
    key: "clockwork_core",
    giver: "Lyra",
    title: "Herz der Maschinen",
    objective: "Dringe in die Clockwork Woods ein und besiege den Wächter der Rootgear Foundry.",
    requiredLevel: 6,
    requires: "sunwatch_vanguard",
    reward: { xp: 800, points: 120 },
  },
] as const;
...
export const aurionEncounters: readonly {
  ...
  { key: "rootgear_foundry", name: "Rootgear-Schmiede", enemyName: "Maschinenwächter", maxBossHp: 480, questKey: "clockwork_core" },
] as const;
