...
describe("explicit identity/time boundary", () => {
  it("prevents reintroduction of implicit randomness and clocks into identity and retry logic", () => {
    const paths = ["client/src/lib/ledger.ts", "client/src/lib/companionLearning.ts", "client/src/lib/companionFrameCapture.ts", "server/_core/retryPolicy.ts", "server/rewardReceiptIdentity.ts", "client/src/lib/visibleCanvasCapture.ts", "client/src/lib/companionWorldInputs.ts"];
