...
export const aurionQuestlineNodes: readonly QuestNode[] = Object.freeze([
  ...
  n("concord.return-names", "sunward_concord", "side", "Die Namen kehren heim", "Sonnenwall", "Nach der Öffnung des Tores müssen die zurückgekehrten Namen einen Platz im neuen Bürgerbuch finden.", ["trade", "craft", "exploration"], ["concord.mainline"], ["warfront.concord"], ["restore", "reconcile", "witness"], { trade: "Vermittle den Familien einen Platz, der nicht wieder gestrichen werden kann.", craft: "Setze eine Gedenktafel in den Wall, ohne daraus ein Denkmal der Sieger zu machen.", exploration: "Finde die verschollene Seite des ersten Bürgerbuchs." }),
  n("concord.warfront-scar", "sunward_concord", "side", "Die Narbe im Schutzkreis", "Sonnenwall", "Der Sieg hat einen Riss hinterlassen: Wer darf entscheiden, welche Opfer als notwendige Kosten gelten?", ["espionage", "combat", "trade"], ["warfront.concord"], [], ["expose", "protect", "listen"], { espionage: "Lege den geheimen Kriegsrat offen.", combat: "Schütze die Zeugen vor denen, die den Riss schließen wollen.", trade: "Schaffe einen Ausgleich für die zerstörten Häuser." }),
  n("ironwardens.field-hospital", "ironwardens", "side", "Hinter dem letzten Schild", "Eisensteppe", "Die Verwundeten beider Seiten warten auf eine Entscheidung, die kein Banner allein treffen kann.", ["craft", "trade", "combat"], ["ironwardens.mainline"], ["warfront.ironwardens"], ["triage", "armistice", "guard"], { craft: "Richte aus Trümmern ein gemeinsames Lazarett her.", trade: "Sichere Heilmittel über eine neutrale Versorgungslinie.", combat: "Halte die Waffenruhe gegen den nächsten Angriff." }),
  n("ironwardens.shield-memory", "ironwardens", "side", "Das Gewicht des Schildes", "Eisensteppe", "Jorens Schild bewahrt einen Namen, den die Reihen nicht hören wollten.", ["exploration", "espionage", "craft"], ["warfront.ironwardens"], [], ["remember", "unseal", "forge"], { exploration: "Finde den Ort, an dem sein Partner zuletzt um Rückzug bat.", espionage: "Öffne das versiegelte Einsatzprotokoll.", craft: "Schmiede aus dem Schild ein Zeichen, das Schutz statt Befehl bedeutet." }),
  n("veiled_covenant.sister-letter", "veiled_covenant", "side", "Der Brief ohne Maske", "Schleierhafen", "Ilyras Schwester kann nur zurückkehren, wenn Wahrheit nicht als Waffe benutzt wird.", ["espionage", "trade", "exploration"], ["veiled_covenant.mainline"], ["warfront.veiled_covenant"], ["deliver", "bargain", "follow"], { espionage: "Liefere den Brief, ohne das Netz der Beobachter zu verraten.", trade: "Erhandle einen Namen, der nicht mehr verkauft werden darf.", exploration: "Verfolge die Handschrift durch die stillen Archive." }),
  n("veiled_covenant.false-command", "veiled_covenant", "side", "Der Befehl, der nicht geschah", "Schleierhafen", "Ein verhinderter Befehl bleibt als Gerücht bestehen und droht die falschen Menschen zu treffen.", ["trade", "craft", "espionage"], ["warfront.veiled_covenant"], [], ["clarify", "forge", "confess"], { trade: "Vereinbare eine öffentliche Korrektur mit den Betroffenen.", craft: "Baue ein Beweissiegel, das nicht gefälscht werden kann.", espionage: "Finde, wer den nie erteilten Befehl verbreitet." }),
  n("wayfarer_compact.return-map", "wayfarer_compact", "side", "Die Karte der Rückkehr", "Randlande", "Tava muss eine Karte zeichnen, die nicht den schnellsten, sondern den gemeinsam möglichen Weg bewahrt.", ["exploration", "craft", "trade"], ["wayfarer_compact.mainline"], ["warfront.wayfarer_compact"], ["mark", "shelter", "share"], { exploration: "Markiere die Wege, die auch die Langsamsten sicher zurückführen.", craft: "Baue Rastplätze aus dem Material der alten Front.", trade: "Sichere Wegrechte, die nach der Krise bestehen bleiben." }),
  n("wayfarer_compact.seventh-beacon", "wayfarer_compact", "side", "Das siebte Leuchtfeuer", "Randlande", "Ein letztes Licht kann die Fronten verbinden oder sie in eine neue Zielscheibe verwandeln.", ["craft", "espionage", "combat"], ["warfront.wayfarer_compact"], [], ["ignite", "conceal", "defend"], { craft: "Errichte das Leuchtfeuer aus fünf verschiedenen Heimaterden.", espionage: "Verberge das Signal vor dem, der Wege zu Fallen macht.", combat: "Verteidige die Helfenden bis zum ersten Morgenlicht." }),
  n("free_haven.water-list", "free_haven", "side", "Die Wasserliste", "Freihafen", "Nikos alte Liste darf nicht verschwinden, aber sie darf auch niemanden für immer verurteilen.", ["trade", "espionage", "exploration"], ["free_haven.mainline"], ["warfront.free_haven"], ["publish", "redact", "repair"], { trade: "Verhandle eine Form der Wiedergutmachung, die den Brunnen offenhält.", espionage: "Prüfe die Liste gegen die Stimmen der Überlebenden.", exploration: "Finde die zweite Wasserader für alle, die keinen Anspruch haben." }),
  n("free_haven.shared-key", "free_haven", "side", "Der geteilte Schlüssel", "Freihafen", "Ein Schlüssel ist nur neutral, wenn jede Hand ihn tragen kann, ohne den Brunnen zu besitzen.", ["craft", "trade", "exploration"], ["warfront.free_haven"], [], ["duplicate", "entrust", "bury"], { craft: "Fertige fünf gleiche Schlüssel mit verschiedenen Geschichten.", trade: "Stifte ein rotierendes Treuhandabkommen.", exploration: "Finde den alten zweiten Zugang unter dem Brunnenkreis." }),
