...
Avoid spread syntax (e.g. { ...obj }) in high-frequency game loops. Explicit property copying (e.g. { x: obj.x, y: obj.y }) is significantly faster and reduces garbage collection pressure.
