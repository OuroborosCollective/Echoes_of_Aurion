...
**Aurion is the single and only owner and truth source.** All gameplay, world, NPC, quest, combat, progression, loot, crafting, economy, group/dungeon, guild, housing, database, persistence, receipts, account, community, assets and operations are authoritative inside Aurion.
