...
vi.mock("@/lib/trpc", () => ({ trpc: {
    ...
    gameplay: { npcActions: { useQuery: () => ({}) }, npcMultiMemory: { useQuery: () => ({}) }, npcSnapshots: { useQuery: () => ({}) }, relationshipStanding: { useQuery: () => ({}) }, currentEncounter: { useQuery: () => ({}) }, startEncounter: { useMutation: () => ({}) }, progress: { useQuery: () => ({}) }, openWorld: { useQuery: () => ({}) }, acceptQuest: { useMutation: () => ({}) }, completeQuest: { useMutation: () => ({}) } },
} }));
