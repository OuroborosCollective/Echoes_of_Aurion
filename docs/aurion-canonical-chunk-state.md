...
Integrate this prerequisite separately from projection PR #431 and client-verification PR #433. Their runtime adapters consume this contract after this prerequisite is reviewed, merged and read back on main. A published PR or successful source test alone does not prove production promotion or completion of Steps 28/29.
