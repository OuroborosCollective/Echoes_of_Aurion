...
- Original proof baseline: Aurion `main@c0ad8967046c52141cf1b5f69874a0c53117fbe2`.
- Clean guard branch baseline: `main@e8614bdcbc9305cd47c85b65de563656e7e8403c`.
...
`pnpm verify:migrations` returned non-zero as designed and reported 28 SQL files, 21 journal entries and exactly the seven unjournaled 0021–0027 tags above.
