...
Zugelassene Quellen sind ausschließlich bereits bestätigte Receipts aus NPC-Entscheidung, NPC-Memory, NPC-Action, World, Quest oder Semantic-Graph-Provenienz. CAG-/LLM-/Renderer-Ausgaben sind keine Faktquellen.
