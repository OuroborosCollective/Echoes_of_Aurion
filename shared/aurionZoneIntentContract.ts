 ...
 * 1. clientSeq ascending
 * 2. arrivalSeq ascending
 * 3. entityId binary ascending
 * 4. type binary ascending
 */
export function orderCanonicalZoneIntents(intents: readonly AurionZoneIntent[]): AurionZoneIntent[] {
  return [...intents].sort((a, b) => {
    ...
    if (a.arrivalSeq !== b.arrivalSeq) return a.arrivalSeq - b.arrivalSeq;
