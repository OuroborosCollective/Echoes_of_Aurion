...
const {manifestSha256,...manifestPayload}=contract.manifest;
if(contract.manifest.version!=='aurion-glb-shipping.v1'||manifestSha256!==hash(canonical(manifestPayload)))throw Error('SHIPPING_MANIFEST_HASH');
