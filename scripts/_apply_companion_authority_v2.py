...
def replace_between(path: str, start: str, end: str, replacement: str) -> None:
    ...
    if start_index < 0 or end_index < 0:
        raise SystemExit(f"{path}: missing markers {start!r} / {end!r}")
...
proof = '''name: Companion learning proof
...
concurrency:
  group: companion-learning-proof-${{ github.ref }}
...
Path("scripts/_apply_companion_authority_v2.py").unlink()
Path(".github/workflows/_companion-authority-v2.yml").unlink()
