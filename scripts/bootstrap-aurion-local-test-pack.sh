...
DB_NAME="aurion_local_test"

for required in manifest.json aurion-source.tar.zst node_modules.tar.zst mariadb-11.4-image.tar.zst schema.sql schema.sha256; do
