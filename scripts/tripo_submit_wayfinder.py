...
entry = ledger["characters"]["aurion-wayfinder"]["generation"]
if entry["status"] != "approved_to_submit" or entry["taskId"] is not None:
    raise SystemExit("Safety gate closed: the Wayfinder generation was already submitted or is not approved.")

prompt = "Full-body single humanoid game character in a neutral upright A-pose, front-facing, slim human Aurion expedition wayfinder. Semi-stylized premium browser-game PBR design: layered ivory field armor, aged bronze trims, deep teal underlayers, short split mantle, closed hood, subtle cyan glowing chest sigil. Clean readable silhouette, no weapon, no floating parts, no cape, no backdrop, no scene, no base. One complete centered character only. Proportions suitable for biped rigging, separate readable arms and legs, watertight geometry, tight topology with no intersecting geometry, uniform vertex density, non-overlapping UV layout, optimized real-time topology, 5k triangles maximum, 1–3 PBR materials, 1024 texture atlas maximum. Do not include text, logos, other characters, or dramatic pose."
