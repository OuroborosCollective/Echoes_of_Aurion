...
const expectedAssetKeys = ["wayfinder", "veilguard"];
...
console.log(`Aurion release asset gate passed: ${baselineReleaseAssets.length} geprüfte GLBs innerhalb von Mobil- und Speicherbudget.`);
