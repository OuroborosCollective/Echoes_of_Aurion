...
### 2026-09-18 — B1 compatible promoter bootstrap repair
Status: VERIFIED pre-merge; production B1 readback remains post-merge.
Änderung: Protocol-2/kompatible, aber nicht byte-identische installierte Promoter dürfen den kanonischen Release nicht mehr direkt ausführen; sie müssen zuerst das revisionsgebundene Bootstrap-Artefakt verwenden und danach byte-identisch zum reviewed Promoter sein, bevor die vier Digest-gebundene Production-Promotion startet.
Erkenntnis: Protokoll-Kompatibilität ist schwächer als Capability-Kompatibilität; ein neuer Compose-Identity-Vertrag darf nicht von einem älteren Root-Promoter ausgeführt werden, auch wenn dessen Entrypoint/Protocol grundsätzlich kompatibel ist.
Evidence: Production run `35315860951` failed closed on merged `46b29847ac7fb99c006226a8ef0910e3dab2f21b` because the older compatible promoter reached compose without AURION_BUILD_INPUT_DIGEST, AURION_ARTIFACT_DIGEST, AURION_RUNTIME_IMAGE_DIGEST and AURION_RELEASE_ARCHIVE_DIGEST; exact repair head `e34e2f6b32168546f0c5a0cb146c5612c2315a62`; Local Test Pack `35317864648` PASS; Runtime Candidate `35317864694` PASS; Runtime Container Proof `35317864731` PASS; Deploy PR verify/build `35317865334` PASS; Root Apply `35317864696` PASS; Zone Bootstrap `35317864667` PASS; AIM-292 `35317864735` PASS.
