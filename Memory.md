...
Status: VERIFIED pre-merge on exact technical head.
Änderung: Aurion erzeugt irreversible Nebenwirkungen nur noch als receipt-gebundene deterministische EffectIntents mit separater 0052-Outbox, append-only Delivery-Receipts und replay-sicherem Worker; Delivery-Status bleibt Side-Channel und Provider-Fehler mutieren keine Gameplay-Authority.
Erkenntnis: Exactly-once ist nur logisch belegbar, wenn effectId aus Authority-Receipt/Typ/Subjekt/Ordinal deterministisch entsteht, Provider dieselbe Idempotency-Key übernehmen und Replay den persistierten Intent unabhängig recomputet, ohne Provider-Aufruf oder Delivery-Receipt; fehlende Intents bleiben UNPROVABLE.
Evidence: Pre-Memory exact head `569bb15a8554be6e6a3546e81e470484ec59b225`; Local Test Pack `35415747420` PASS through targeted Step-24 contract/MariaDB/readback, typecheck/classless and full repository regression; Schema Reconciliation `35415747286` PASS; Root Apply `35415747374` PASS; Root Reconciliation `35415747429` PASS; Journal Watermark `35415747435` PASS; Zone Bootstrap `35415747478` PASS; Runtime Candidate `35415747317` PASS; Runtime Container Proof `35415747368` PASS; Android `35415747401` PASS.
