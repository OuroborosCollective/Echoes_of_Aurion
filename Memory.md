...
### 2026-09-18 — B1 promoter bootstrap digest bridge repair
Status: VERIFIED pre-merge; real post-merge production B1 PASS remains required.
Änderung: Jeder erkannte, aber nicht byte-identische installierte Promoter (Legacy oder Protocol-2-kompatibel) muss zuerst das Bootstrap-Artefakt konsumieren und den kanonischen Promoter byte-identisch installieren; unbekannte Promoter bleiben fail-closed und fehlende Self-Update-Identität bricht mit Exit 71 ab.
Erkenntnis: Protokoll-Kompatibilität reicht bei einem verschärften Compose-/Environment-Vertrag nicht aus; vor der Production-Promotion muss die ausführende Promoter-Datei selbst revisionsgebunden auf die kanonischen Bytes aktualisiert und gelesen werden.
Evidence: Exact technical head `c469f0e919415a3ec13363899d8cffd61031b4c7`; Local Test Pack `35318653080` PASS (255 Test Files / 1107 Tests; 33/126 explicit skipped; B8 repository PASS); Runtime Candidate `35318653127` PASS; Runtime Container Proof `35318653245` PASS; Deploy PR verify/build `35318653794` PASS; Root Apply `35318653043` PASS through 0050; Zone Bootstrap `35318653067` PASS; AIM-292 `35318653099` PASS; Local Pack artifact `sha256:cc043d781fc9e1a618a24df396a4937882a81ce1cf02f88d1089c82740bd64b4`; Container evidence `sha256:9ccf4c6ac5b725109cd0e0d490b7d5286d076eb799f76144d05374fc1654cd70`; Wolfram state machine: canonical-direct / bootstrap-then-canonical / reject-71 / reject-70.
